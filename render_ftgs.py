...
Usage:
python3 render_ftgs.py --ply_path ./compression/test/FreeTimeGS/006_1_seq1.ply --data_dir ./compression/test/006_1_seq1
"""
...
def render_camera_view(ply_path, camera, output_path, frames, fps=60, near=0.01, far=10000, device="cuda"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--far", type=float, default=10000)
